...
const PROFILES: Dictionary = {
	...
	"board_cursor": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "pause", "help"],
	"twin_stick": ["move_up", "move_down", "move_left", "move_right",
		"aim_up", "aim_down", "aim_left", "aim_right", "primary", "secondary",
		"mobility", "pause", "help"],
	"artillery": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "pause", "help"],
	"arena_grid": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "pause", "help"],
	"physics_sport": ["move_up", "move_down", "move_left", "move_right",
		"primary", "mobility", "pause", "help"],
	"capture_racer": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "pause", "help"],
	"aerial_duel": ["move_up", "move_down", "move_left", "move_right",
		"primary", "mobility", "pause", "help"],
	"fighter": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "mobility", "stance", "pause", "help"],
	"tactics_grid": ["move_up", "move_down", "move_left", "move_right",
		"primary", "secondary", "pause", "help"],
