...
static var ITEMS: Dictionary = {
	...
	"drone": {"name": "Scout drone", "emoji": "🛸", "usable": true, "w": 3.0, "cat": "tool", "desc": "USE deploys the bird — it patrols and pings threats. Deploying hands you the REMOTE."},
	"drone_remote": {"name": "Drone remote", "emoji": "🎛️", "usable": true, "w": 0.3, "cat": "tool", "desc": "USE takes the stick of your bird in the sky. Dies with the bird."},
