...
- [x] **Step 1: Write the failing registry sim**
...
- [x] **Step 2: Run the sim and verify the missing registry fails**
...
- [x] **Step 3: Add the complete 22-row catalog and four device rows**
...
- [x] **Step 4: Implement strict registry validation**
...
- [x] **Step 5: Import and rerun the registry sim**
...
- [x] **Step 1: Write the failing deterministic WASTE HEAP sim**
...
- [x] **Step 2: Run and observe the missing scene failure**

Expected: non-zero load failure for `waste_heap.tscn`.

- [x] **Step 3: Implement the base lifecycle and result idempotency**
...
- [x] **Step 4: Implement standard 4×4 2048 behavior and minimal ink/amber rendering**
...
- [x] **Step 1: Add a failing input sim**
...
- [x] **Step 2: Run and verify `arcade_primary` is absent**

Expected: the first ARCADE action check fails.

- [x] **Step 3: Add semantic rows**
...
- [x] **Step 4: Implement event-device-preserving snapshots**
...
- [x] **Step 5: Run `input_map_sim` and `game_input_sim` serially**
...
- [x] **Step 1: Write the failing ledger sim**
...
- [x] **Step 2: Run and verify the missing class failure**

- [x] **Step 3: Implement validation and capped persistence**
...
- [x] **Step 1: Write the failing shell lifecycle sim**
...
- [x] **Step 2: Run and verify missing deck/shell classes fail**

- [x] **Step 3: Implement the deck state machine**
...
- [x] **Step 4: Implement the heavy-bezel shell**
...
- [x] **Step 5: Run the shell and WASTE HEAP sims serially**
...
- [x] **Step 1: Write the failing chess rules sim**
...
- [x] **Step 2: Run and verify the missing scene failure**

- [x] **Step 3: Implement complete deterministic chess rules**
...
- [x] **Step 4: Add deterministic material-plus-mobility AI**
...
- [x] **Step 5: Add a 16:9 board and original battle vignette**
...
- [x] **Step 6: Run the focused chess and shell sims**
...
- [x] **Step 1: Write the failing offline/authority sim**
...
- [x] **Step 2: Run and verify missing bridge failure**

- [x] **Step 3: Implement the generic RPC envelope**
...
- [x] **Step 4: Add the bridge to `ProtoNet.create()`**
...
- [x] **Step 5: Run existing `net_loopback.sh` and the new sim serially**
...
- [x] **Step 1: Write failing device, save, and license sims**
...
- [x] **Step 2: Run and capture the three expected failures**

- [x] **Step 3: Implement procedural physical devices**
...
- [x] **Step 4: Integrate one deck into `ProtoMain` surgically**
...
- [x] **Step 5: Add proof manuals and notices**
...
- [x] **Step 6: Run new sims plus regression sims serially**
...
- [x] **Step 7: Commit only Game Deck changes**
...
- [x] **Step 1: Run `git diff --check` and inspect staged scope**

Expected: no whitespace errors and no unrelated file staged.

- [x] **Step 2: Run all Phase 1.0 sims serially**
...
- [x] **Step 3: Inspect the physical result in Godot**
