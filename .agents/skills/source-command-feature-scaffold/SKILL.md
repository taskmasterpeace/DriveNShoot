---
name: "source-command-feature-scaffold"
description: "Scaffold new feature with proper src/features/ architecture"
---

# source-command-feature-scaffold

Use this skill when the user asks to run the migrated source command `feature-scaffold`.
...
Codex: I'll scaffold the video-editor feature for you.
