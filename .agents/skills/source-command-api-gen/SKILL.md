---
name: "source-command-api-gen"
description: "Generate Next.js API route with auth, validation, and error handling"
---

# source-command-api-gen

Use this skill when the user asks to run the migrated source command `api-gen`.
...
Codex: I'll create a video generation API endpoint.
